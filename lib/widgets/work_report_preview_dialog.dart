            ...
            Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.assignment, color: Colors.blue[700], size: 32),
                ),
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    _buildSectionHeader('🤖 Tóm tắt tự động', Icons.auto_awesome),
                    Container(
                    ...
                    if (widget.report.completedTasks.isNotEmpty) ...[
                      _buildSectionHeader('✅ Công việc đã hoàn thành', Icons.task_alt),
                      ...widget.report.completedTasks.map((task) => 
                        _buildTaskCard(task),
                      ),
                      const SizedBox(height: 24),
                    ],
                    ...
                    _buildSectionHeader('💭 Ghi chú thêm (tùy chọn)', Icons.edit_note),
                    TextField(
                      controller: _notesController,
                      maxLines: 3,
                      decoration: InputDecoration(
                        hintText: 'Bổ sung thêm chi tiết về công việc hôm nay...',
                    ...
                    // Challenges (editable)
                    _buildSectionHeader('🚧 Khó khăn gặp phải (tùy chọn)', Icons.warning_amber),
                    TextField(
                      controller: _challengesController,
                      maxLines: 2,
                      decoration: InputDecoration(
                        hintText: 'VD: Thiếu công cụ\nGặp vấn đề kỹ thuật\nCần hỗ trợ từ quản lý',
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(12),
                        ),
                        filled: true,
                    ...
                    _buildSectionHeader('📅 Kế hoạch ngày mai (tùy chọn)', Icons.event_note),
                    TextField(
