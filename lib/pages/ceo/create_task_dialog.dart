...
class _CreateTaskDialogState extends ConsumerState<CreateTaskDialog> {
  ...
  Future<void> _createTask() async {
    ...
    try {
      ...
      // Get assignee details if selected
      String? assigneeName;
      String? assigneeRole;
      if (_selectedAssigneeId != null) {
        ...
        if (employees.isNotEmpty) {
          try {
            ...
            assigneeRole = assignee.role.name; // Get role
          } catch (_) {
      ...
      final task = Task(
        ...
        branchId: widget.branchId ?? user.branchId, // Use provided branchId or user's branchId
        ...
        assignedToRole: assigneeRole, // Set role
        dueDate: _selectedDueDate,
        createdBy: user.id, // This should be employee ID
