...
/// Manager Employees Page - Show all employees in manager's company
class ManagerEmployeesPage extends ConsumerStatefulWidget {
  const ManagerEmployeesPage({super.key});

  @override
  ConsumerState<ManagerEmployeesPage> createState() =>
      _ManagerEmployeesPageState();
}

class _ManagerEmployeesPageState extends ConsumerState<ManagerEmployeesPage> {
  ...
  Future<void> _loadEmployees() async {
    ...
    try {
      ...
      // Get all employees from same company
