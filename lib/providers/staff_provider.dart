...
final allStaffProvider =
    FutureProvider.autoDispose.family<List<Staff>, String?>((ref, branchId) async {
...
final companyStaffProvider =
    FutureProvider.autoDispose.family<List<Staff>, String?>((ref, companyId) async {
  final service = ref.read(staffServiceProvider);
...
final staffProvider =
    FutureProvider.autoDispose.family<Staff?, String>((ref, staffId) async {
  final service = ref.read(staffServiceProvider);
...
final staffByRoleProvider =
    FutureProvider.autoDispose.family<List<Staff>, ({String role, String? branchId})>(
        (ref, params) async {
  final service = ref.read(staffServiceProvider);
...
final staffStreamProvider =
    StreamProvider.autoDispose.family<List<Staff>, String?>((ref, branchId) {
  final service = ref.read(staffServiceProvider);
