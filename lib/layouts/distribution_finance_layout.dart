...
class _DistributionFinanceLayoutState
  ...
  List<Widget> get _pages => [
    _FinanceDashboardPage(onNavigate: _navigateToTab),
    const _InvoicesPage(),      // Tab xuất hóa đơn
...
class _FinanceDashboardPage extends ConsumerStatefulWidget {
  const _FinanceDashboardPage({this.onNavigate});
...
class _FinanceDashboardPageState extends ConsumerState<_FinanceDashboardPage> {
  ...
  Future<void> _loadDashboardData() async {
    try {
      ...
      // Get revenue this month (completed orders)
                              ...
                              children: [
                                Expanded(
                                  child: _buildQuickAction(
                                    ...
                                    Colors.green,
                                    () {
                                      // Navigate to Payments tab (index 3)
                                ...
                                Expanded(
                                  child: _buildQuickAction(
                                    ...
                                    Colors.orange,
                                    () {
                                      // Navigate to Accounts Receivable tab (index 2)
                ...
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      onPressed: () {
                        ...
                        widget.onNavigate?.call(2); // Go to Công nợ tab
                      },
                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      onPressed: () {
                        Navigator.pop(context);
                        widget.onNavigate?.call(3); // Go to Thu tiền tab
                      },
